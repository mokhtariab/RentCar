...
namespace RentCarPrj.SMSService {
    using System;
    ...
    public partial class v2 : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public v2() {
            this.Url = global::RentCarPrj.Properties.Settings.Default.RentCarPrj_com_parsasms_v2;
        ...
        public C_News[] GetNewsList(string username, string password) {
            object[] results = this.Invoke("GetNewsList", new object[] {
                        username,
                        password});
            return ((C_News[])(results[0]));
        }
    ...
    public partial class GetNewsListCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        ...
        /// <remarks/>
        public C_News[] Result {
            get {
                this.RaiseExceptionIfNecessary();
                return ((C_News[])(this.results[0]));
            }
        }
    }
}
